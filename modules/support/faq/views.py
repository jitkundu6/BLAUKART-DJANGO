...
def home(request):
    ...
    return render(request,'faq/faq.html',{'quests':quests})
...
def register(request):
    ...
    return render(request,'faq/registration/register.html',{'form':form})
...
def ask_form(request):
    ...
    return render(request,'faq/ask-question.html',{'form':form})
...
def tag(request,tag):
    ...
    page_num=request.GET.get('page',1)
    quests=paginator.page(page_num)
    return render(request,'faq/tag.html',{'quests':quests,'tag':tag})
...
def profile(request):
    ...
    return render(request,'faq/registration/profile.html',{
        'form':form,
        'quests':quests,
        'answers':answers,
        'comments':comments,
...
def tags(request):
    ...
    return render(request,'faq/tags.html',{'tags':tag_with_count})
